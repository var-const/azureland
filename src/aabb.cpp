...
CRI_AABB::VecT IntersectionNormal(
    const CRI_AABB A, const CRI_AABB B, const CRI_AABB::VecT Depth)
{
...
void SetAABB(
    CRI_AABB& Box, const CRI_AABB::VecT Center, const CRI_AABB::VecT HalfSize)
{
    Box.m_Center = Center;
...
void SetAABB(
    CRI_AABB& Box, CRI_AABB::VecT const& Center, CRI_AABB::VecT const& HalfSize)
{
    Box.m_Center = Center;
    Box.m_HalfSize = HalfSize;
}
